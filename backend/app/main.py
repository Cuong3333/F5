...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["http://localhost:3000"],  # Update to the specific frontend origin
#     allow_credentials=True,
...
#         messages=[
#             {"role": "system", "content": (
#                 "Tất cả thông tin bạn sử dụng tôi muốn bạn lấy từ nguồn uy tín ở trên các website"
#                 "Bạn là một trợ lý sức khỏe của tôi. Trả lời ngắn gọn, rõ ràng và không dùng ký tự ** để nhấn mạnh bất kỳ thông tin nào."
#                 "Trả lời dạng danh sách mỗi mục xuống dòng và tránh lặp lại ký hiệu đặc biệt như dấu * hoặc ** trong toàn bộ câu trả lời."
#                 f"Tôi là {Name}, tôi {Age} tuổi, chiều cao của tôi là {cao}, và cân nặng của tôi là {can}. {benh}."
#             )},
...
# @app.get("/initial-chat")
# async def get_initial_chat():
#     # Example initial messages, replace with your actual data
#     initial_messages = [
#         {"sender": "bot", "text": "Welcome! How can I assist you today?", "is_task": False},
#         {"sender": "bot", "text": "Feel free to ask questions about our services.", "is_task": False}
#     ]
