...
const UserInfo = ({ user }) => {
  return (
    <div className='px-4'>
      {/* Popover là một thành phần giao diện người dùng (UI component) trong các ứng dụng web hoặc ứng dụng di động, được dùng để hiển thị nội dung bổ sung (thông tin, lựa chọn, hành động...) trong một cửa sổ nhỏ hoặc một hộp nổi bật khi người dùng tương tác với một phần tử cụ thể (như một nút, liên kết, hoặc phần tử UI khác). */}
